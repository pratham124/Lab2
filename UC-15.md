...
- **7e**: The editor attempts to change or resend the final decision payload after finalization.
  - **7e1**: The system rejects the attempt as a conflict and preserves the original final decision.

## Related Information

- **Priority**: High
- **Frequency**: Medium
- **Decision Notification Status Values**: `sent`, `partial`, `failed`
