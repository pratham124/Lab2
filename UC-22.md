...
- The ticket includes an invoice number, is delivered via email only, and remains accessible through the conference end date plus 90 days.

## Failed End Condition

- The payment confirmation ticket is not delivered or accessible, and the system informs the attendee of the issue with a generic message and support contact path.
...
5. The CMS sends the payment confirmation ticket to the attendee via email (email-only delivery).
6. The system displays a confirmation message indicating that the ticket has been issued.
7. The attendee accesses the confirmation ticket from the CMS, with access available through conference end date plus 90 days.
...
- **7b**: The attendee attempts to access the ticket after the retention period ends.
  - **7b1**: The system denies access and displays a retention-ended message.
